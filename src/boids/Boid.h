...
public: // Properties
	...
	constexpr sf::Vector2f get_saved_position() const noexcept { return _saved_position; }
	...
	constexpr sf::Vector2f get_saved_velocity() const noexcept { return _saved_velocity; }
	...
	constexpr sf::Vector2f get_saved_origin() const
	{
