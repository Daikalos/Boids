...
public:
	...
	sf::Vector3f get_color(const RectFloat& border, const IAudioMeterInfo* audio_meter, std::span<const Impulse> impulses) const noexcept;
...
private:
	...
	sf::Vector3f cycle_color() const;
	sf::Vector3f density_color() const;
	sf::Vector3f velocity_color() const;
	sf::Vector3f rotation_color() const;
	sf::Vector3f audio_color(const IAudioMeterInfo* audio_meter) const;
	void impulse_color(sf::Vector3f& color, std::span<const Impulse> impulses) const;
