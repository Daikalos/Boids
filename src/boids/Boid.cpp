...
sf::Vector3f Boid::position_color(const RectFloat& border) const
{
	...
	return sf::Vector3f(
		util::interpolate(_config->boid_color_top_left.x * 255.0f, _config->boid_color_top_right.x * 255.0f, _config->boid_color_bot_left.x * 255.0f, _config->boid_color_bot_right.x * 255.0f, t, s) / 255.0f,
		util::interpolate(_config->boid_color_top_left.y * 255.0f, _config->boid_color_top_right.y * 255.0f, _config->boid_color_bot_left.y * 255.0f, _config->boid_color_bot_right.y * 255.0f, t, s) / 255.0f,
		util::interpolate(_config->boid_color_top_left.z * 255.0f, _config->boid_color_top_right.z * 255.0f, _config->boid_color_bot_left.z * 255.0f, _config->boid_color_bot_right.z * 255.0f, t, s) / 255.0f);
}
