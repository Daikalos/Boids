...
{
public:
	static inline float length(sf::Vector2<T> vector)
	{
		return std::sqrtf(vector.x * vector.x + vector.y * vector.y);
	}
	static inline float angle(sf::Vector2<T> vector)
	{
		return atan2f(vector.y, vector.x);
	}
	static inline float angle(sf::Vector2<T> lhs, sf::Vector2<T> rhs)
	{
		return acosf(dot(lhs, rhs) / (length(lhs) * length(rhs)));
	}
	static inline float angle(sf::Vector2<T> lhs, sf::Vector2<T> rhs, float lhs_length, float rhs_length)
	{
		return acosf(dot(lhs, rhs) / (lhs_length * rhs_length));
	}

	static inline float dot(sf::Vector2<T> lhs, sf::Vector2<T> rhs)
	{
		return lhs.x * rhs.x + lhs.y * rhs.y;
	}
	static inline float cross(sf::Vector2<T> lhs, sf::Vector2<T> rhs)
	{
		return lhs.x * rhs.y - lhs.y * rhs.x;
	}

	static inline float distance(sf::Vector2<T> from, sf::Vector2<T> to)
	{
	...
	static inline float distance_squared(sf::Vector2<T> from, sf::Vector2<T> to)
	{
...
template <typename T> 
static inline sf::Vector2<T> operator /=(sf::Vector2<T>& lhs, sf::Vector2<T> rhs)
{
	lhs.x /= rhs.x;
	lhs.y /= rhs.y;
	return lhs;
...
template <typename T>
static inline sf::Vector2<T> operator /(float lhs, sf::Vector2<T> rhs)
{
